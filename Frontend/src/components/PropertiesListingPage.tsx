      ...
      <div className="min-h-screen w-full overflow-x-hidden bg-[#eef4fb] p-1.5 sm:p-3">
        <div className={`mx-auto grid max-w-[1580px] grid-cols-[minmax(0,1fr)] gap-2.5 md:gap-4 ${
              ...
              <div className="relative mt-3">
                ...
                >
                  {happeningProjects.length === 0 ? (
                    ...
                    <div
                      key={pick._id}
                      className="grid h-44 w-[82%] shrink-0 snap-start grid-cols-[110px_1fr] overflow-hidden rounded-lg bg-gradient-to-br from-cyan-100 via-sky-50 to-amber-50 shadow-sm sm:w-[calc(50%-0.375rem)] sm:grid-cols-[140px_1fr]"
                    >
          ...
          <aside className="order-2 flex h-auto min-h-[360px] flex-col gap-2.5">
            ...
            <div className="rounded-2xl bg-white p-2.5 shadow-sm sm:p-3 md:h-[1150px] md:overflow-y-auto">
